  ...
  <form id="uploadPicture" enctype="multipart/form-data" method="post">
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/image/cert-example-19.png" alt="" class="example-pic">
          </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/image/cert-example-20.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
...
$('#submit').on('click', function(){
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo ENTRY_API_SITE_URL;?>/officer.submit.cert.residentbook.php',
    data: formData,
    processData : false,
    contentType : false,
    dataType: 'json',
