  ...
  <form id="uploadPicture" enctype="multipart/form-data" method="post">
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/image/cert-example-11.png" alt="" class="example-pic">
          </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/image/cert-example-12.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
    ...
    success: function(data){
      ...
      if(data.STS){
        ...
        var times = setInterval(function(){
          ...
          if(count <= 1){
            clearInterval(times);
            window.location.href = "<?php echo getUrl('home', 'certTypeList', array('type'=>certificationTypeEnum::LAND,'back'=>'certList','id'=>$_GET['id']), false, WAP_OPERATOR_SITE_URL)?>";
          }
        },1000);
      }else{
        verifyFail(data.MSG);
