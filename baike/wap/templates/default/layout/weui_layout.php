...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/weui/weui.extend.css?v=<?php echo time()?>">
    ...
    <div class="js_dialog" id="iosDialog" style="opacity: 0; display: none;">
        ...
        <div class="weui-dialog">
            ...
            <div class="weui-dialog__ft">
                <a href="javascript:$('#iosDialog').fadeOut(200);" class="weui-dialog__btn weui-dialog__btn_primary">Got It</a>
            </div>
        </div>
    </div>
