    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a class="current"><span>Transaction For Account By Value Date</span></a></li>
                ...
                <li><a href="<?php echo getUrl('report_gl_transaction', 'reprintOldBatch', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Reprint Old Batch</span></a></li>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_gl_transaction/transaction.for.account.by.value.date.list",
            dynamic: {
                api: "report_gl_transaction",
                method: "getTransactionForAccountByValueDateList",
                param: {
