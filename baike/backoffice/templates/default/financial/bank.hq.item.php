    ...
    <div class="panel-body" style="color: #808080;">
        <div class="col-sm-4">
           <ul class="list-group no-border">
               ...
               <li class="list-group-item">
                   <?php if($bank['is_allow_billpay']){?>
                       <i class="fa fa-check"></i>
                   <?php }else{?>
                       <i class="fa fa-close"></i>
                   <?php }?>
                   <span style="padding-left: 10px">Allow BillPay</span>
               </li>
               <li class="list-group-item" style="padding-top: 2px;padding-bottom: 2px">
                   <a class="btn btn-default btn-block" title="<?php echo $lang['common_edit'] ;?>" href="<?php echo getUrl('financial', 'editBank', array('uid'=>$bank['uid']), false, BACK_OFFICE_SITE_URL); ?>" style="margin-right: 5px" >
                       <i class="fa fa-edit"></i>
                       Edit
                   </a>
               </li>
               <li class="list-group-item" style="padding-top: 2px;padding-bottom: 2px">
                   <a class="btn btn-default btn-block" title="<?php echo $lang['common_delete'];?>" href="<?php echo getUrl('financial', 'deleteBank', array('uid'=>$bank['uid']), false, BACK_OFFICE_SITE_URL); ?>">
