...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a href="<?php echo getUrl('report_general_ledger', 'generalLedger', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Full Trial Balance</span></a></li>
                ...
                <li><a class="current"><span>Trial Balance For A selected Month</span></a></li>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_general_ledger/balance.for.month.list",
            dynamic: {
                api: "report_general_ledger",
                method: "getBalanceForMonthList",
                param: {
