...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_loan/loan.provision.contract.list",
            dynamic: {
                api: "report_loan",
                method: "getLoanProvisionContract",
                param: _values
            },
    ...
    function exportExcel() {
        ...
        _values.op = 'exportLoanProvisionContract';
    ...
    function printPage() {
        ...
        _values.op = 'printLoanProvisionContract';
        _values.tpl = 'report_loan/loan.provision.contract.list';
