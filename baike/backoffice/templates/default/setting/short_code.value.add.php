    ...
    <div class="container" style="width: 600px;">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="category" placeholder="" value="<?php echo $output['category'] ?>" readonly>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="item_name" placeholder="" value="<?php echo $_GET['item_name'] ?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="item_code" placeholder="" value="<?php echo $_GET['item_code'] ?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="item_value" placeholder="" value="<?php echo $_GET['item_value'] ?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="item_desc" placeholder="" value="<?php echo $_GET['item_desc'] ?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
