...
<!--                <li>-->
<!--                    <a href="--><?php //echo getUrl('setting', 'addShortCodeCategory', array(), false, BACK_OFFICE_SITE_URL . '/index.php') ?><!--"><span>Add</span></a>-->
<!--                </li>-->
    ...
    <div class="container" style="width: 500px;">
        <form class="form-horizontal" method="post">
            ...
            <input type="hidden" name="category_key" value="<?php echo $output['category']?>">
            <div class="form-group">
                <label class="col-sm-3 control-label"><span class="required-options-xing">*</span><?php echo 'Category' ?></label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="category" placeholder="" value="<?php echo $output['category']?>">
