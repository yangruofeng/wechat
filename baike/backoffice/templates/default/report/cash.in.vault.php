                                ...
                                <tr>
                                    <td>
                                        <div class="input-group">
                                            <input type="text" class="form-control input-search" id="search_text" name="search_text" placeholder="<?php if($output['title'] == 'Headquarters'){echo 'Search for CID/code/name';}else{echo 'Search for code/name/phone';}?>" style="min-width: 200px">
