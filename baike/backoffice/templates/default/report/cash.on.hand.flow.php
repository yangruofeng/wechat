        ...
        <div class="col-sm-12">
            <div class="basic-info">
                ...
                <div class="col-sm-12 user-info">
                    <div class="col-sm-3">
                        User Code: <label for=""><?php echo $info['user_code'];?></label>
                    </div>
                    <div class="col-sm-3">
                        User Name: <label for=""><?php echo $info['user_name'];?></label>
                    </div>
                    <div class="col-sm-3">
                        Mobile Phone: <label for=""><?php echo $info['mobile_phone'];?></label>
                    </div>
                    <div class="col-sm-3">
                        User Position: <label for=""><?php echo $info['user_position'];?></label>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report/cash.on.hand.flow.list",
            dynamic: {
                api: "report",
