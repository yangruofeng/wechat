...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_super_loan/trx.repay.list",
            dynamic: {
                api: "report_super_loan",
                method: "getTrxRepayList",
                param: _values
            },
    ...
    function exportExcel() {
        ...
        _values.op = 'exportRepayTransaction';
    ...
    function printPage() {
        ...
        _values.op = 'printRepayTransaction';
        _values.tpl = 'report_super_loan/trx.repay.list';
