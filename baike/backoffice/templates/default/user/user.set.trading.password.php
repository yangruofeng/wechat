    ...
    <div class="collection-div">
        <div class="register-div">
            <div class="basic-info">
                <div class="ibox-title" style="padding: 15px 5px!important;">
                    <h5><i class="fa fa-id-card-o"></i>Setting Trading Password</h5>
                </div>
                <div class="content">
                    <form class="form-horizontal" id="form-change" action="<?php echo getUrl('user', 'verifyChangeTradePwd', array(), false, BACK_OFFICE_SITE_URL) ?>"
                          method="post">
                       ...
                       <!-- <div class="col-sm-6 form-group" id="by_phone">
                        ...
                        <div class="col-sm-6 form-group" id="by_password" style="">
                            <label class="col-sm-5 control-label" style="padding-left: 0!important;"><span class="required-options-xing">*</span>
                                <?php echo $is_first_setting?'Login password':'Old Trading Password'; ?>
                            </label>
                            <div class="col-sm-7">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="hint">
                                    ...
                                    To change the trading password, must enter the verification code or the original password.</div>
                            </div>
                        </div>
