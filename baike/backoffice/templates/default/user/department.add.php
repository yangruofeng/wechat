...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li>
                    <a href="<?php echo getUrl('user', 'department', array('uid'=>$output['branch_id']), false, BACK_OFFICE_SITE_URL) ?>"><span>List</span></a>
                </li>
    ...
    <div class="container" style="width: 600px;">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="depart_code" placeholder="" value="<?php echo $_GET['depart_code'] ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="depart_name" placeholder="" value="<?php echo $_GET['depart_name'] ?>">
                    <div class="error_msg"></div>
                </div>
            </div>
<!--            <div class="form-group">
