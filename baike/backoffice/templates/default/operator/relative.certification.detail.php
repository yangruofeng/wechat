...
$relative_info = $info['relative_detail_info'];
?>
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>Relative Verification File</h3>
            <ul class="tab-base">
                ...
                <?php } else { ?>
                    <li>
                        <a href="<?php echo getUrl('operator', 'relativeCertificateFile', array('type' => $info['cert_type']), false, BACK_OFFICE_SITE_URL) ?>"><span><?php echo $output['title'] . ' List'?></span></a>
                    </li>
                    <li><a class="current"><span>Detail</span></a></li>
                <?php }?>
            </ul>
    ...
    <div class="container">
        ...
        <?php } ?>
        <form class="demoform" id="validIDForm" method="post" action="<?php echo getUrl('operator', 'relativeCertificationConfirm', array(), false, BACK_OFFICE_SITE_URL) ?>">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $info['relative_name']; ?>
                        (<?php echo $info['relation_name']; ?>)
                    </td>
                </tr>
                ...
                <?php if ($info['cert_type'] == certificationTypeEnum::ID) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?php echo implode(' ', my_json_decode($relative_info['id_en_name_json'])); ?>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?php echo implode(' ', my_json_decode($relative_info['id_kh_name_json'])); ?>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?php echo $relative_info['id_type'] == 1 ? "Foreign Country" : "Homeland"; ?>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?php echo ucwords($relative_info['gender']); ?>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?php echo dateFormat($relative_info['birthday']); ?>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?php echo strtoupper($relative_info['nationality']); ?>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($info['verify_state'] == certStateEnum::PASS) { ?>
                            ...
                            <?php } else { ?>
                                <button type="button" class="btn btn-info" onclick="javascript:window.location.href = '<?php echo getUrl('operator', 'relativeCertificateFile', array('type' => $info['cert_type']), false, BACK_OFFICE_SITE_URL) ?>';">
                                    <i class="fa fa-vcard-o"></i>Back
                                </button>
                            <?php } ?>
                        <?php } elseif ($info['verify_state'] == certStateEnum::NOT_PASS) { ?>
                        ...
                        <?php } else { ?>
                            <div class="custom-btn-group approval-btn-group">
                                ...
                                <button type="button" class="btn btn-default" onclick="javascript:window.location.href = '<?php echo getUrl('operator', 'relativeCertificateFile', array('type' => $info['cert_type']), false, BACK_OFFICE_SITE_URL) ?>';"><i class="fa fa-reply"></i><?php echo 'Back' ?></button>
                            </div>
                        <?php } ?>
                    </td>
                </tr>
