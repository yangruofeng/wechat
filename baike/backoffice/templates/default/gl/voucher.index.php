...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a class="current"><span>New Voucher</span></a></li>
                <li><a href="<?php echo getUrl('gl_tree', 'showVoucherListPage', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Voucher List</span></a></li>
            </ul>
        </div>
    </div>
