...
;(function(factory) {
    ...
    editormd.toolbarModes = {
        ...
        custom: ["undo", "redo", "|","bold", "del", "italic", "quote", "ucwords", "uppercase", "lowercase", "|","h1", "h2", "h3", "h4", "h5", "h6", "|","list-ul", "list-ol", "hr", "|","link", "reference-link", "image", "code", "preformatted-text","code-block", "table", "datetime",   "pagebreak", "|","goto-line", "watch", "preview", "fullscreen", "clear", "|"]
    };
    ...
    editormd.createDialog = function(options) {
        ...
        var dialogPosition = function(){
            dialog.css({
                //top    : ($(window).height() - dialog.height()) / 2 + "px",//$(window).height()不知为何获取的是文档的高度
                top    : (window.innerHeight - dialog.height()) / 2 + "px",
                left   : ($(window).width() - dialog.width()) / 2 + "px"
            });
        };
