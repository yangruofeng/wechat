  ...
  <form id="uploadPicture" enctype="multipart/form-data" method="post">
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-13.png" alt="" class="example-pic">
          </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-14.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-15.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-16.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-17.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-18.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
    ...
    success: function(data){
      ...
      if(data.STS){
        ...
        var times = setInterval(function(){
          ...
          if(count <= 0){
            clearInterval(times);
            window.location.href = "<?php echo getUrl('credit', 'certTypeList', array('type'=>certificationTypeEnum::HOUSE,'back'=>'certList'), false, WAP_SITE_URL)?>";
          }
        },1000);
      }else{
        verifyFail(data.MSG);
