<link rel="stylesheet" type="text/css" href="<?php echo WAP_SITE_URL;?>/resource/css/credit.css?v=5">
  ...
  <form id="uploadPicture" enctype="multipart/form-data" method="post">
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-19.png" alt="" class="example-pic">
          </div>
    ...
    <div class="cerification-picture aui-margin-b-10">
      <div class="upload-wrap clearfix">
        ...
        <div class="up-example">
          <div class="up-exam">
            <img src="<?php echo WAP_SITE_URL;?>/resource/image/cert-example-20.png" alt="" class="example-pic">
          </div>
          <div class="name"><?php echo $lang['label_example'];?></div>
        </div>
      </div>
...
$('#submit').on('click', function(){
  var front_photo = $('#front_photo_check_img').attr('src'), back_photo = $('#back_photo_check_img').attr('src');
  ...
  $.ajax({
    type: 'POST',
    url: '<?php echo ENTRY_API_SITE_URL;?>/member.cert.residentbook.php',
    data: formData,
    processData : false,
    contentType : false,
    dataType: 'json',
...
var demo_h5_upload_ops = {
    ...
    eventBind:function(){
        var that = this;
        $("#front_photo,#back_photo").change(function(){
