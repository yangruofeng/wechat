      ...
      <li class="aui-list-item aui-list-item-middle" onclick="getDetail({{=it[i]['uid']}});">
        <div class="aui-media-list-item-inner">
          <div class="aui-list-item-inner aui-list-item-arrow">
            ...
            <div class="aui-list-item-text">
              <div class="aui-list-item-title title"><?php echo $lang['label_insurance_fee'].$lang['label_colon'];?></div>
              <div class="aui-list-item-right text">{{=it[i]['price']}} {{=it[i]['currency']}}</div>
            </div>
            <div class="aui-list-item-text">
              <div class="aui-list-item-title title"><?php echo $lang['label_insurance_amount'].$lang['label_colon'];?></div>
              <div class="aui-list-item-right text" style="color:red;">{{=it[i]['start_insured_amount']}} {{=it[i]['currency']}}</div>
            </div>
          </div>
        </div>
      </li>
...
<script type="text/javascript">
  ...
  function getPageData(){
    $.ajax({
      type: 'POST',
      url: '<?php echo WAP_SITE_URL;?>/index.php?act=member&op=getInsuranceContractData',
