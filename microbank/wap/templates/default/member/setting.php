...
<div class="wrap setting-wrap">
  <div class="aui-content aui-margin-b-10">
    <ul class="aui-list user-item">
      <li class="aui-list-item" onclick="javascript:location.href='<?php echo getUrl('member', 'changePassword', array(), false, WAP_SITE_URL)?>'">
        <div class="aui-list-item-inner aui-list-item-arrow">
          <?php echo $lang['label_password'];?>
        </div>
      </li>
      <li class="aui-list-item">
        <div class="aui-list-item-inner aui-list-item-arrow" onclick="javascript:location.href='<?php echo getUrl('member', 'changeLang', array(), false, WAP_SITE_URL)?>'">
