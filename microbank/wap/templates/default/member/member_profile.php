        ...
        <div class="aui-list-item-inner avatar-item aui-list-item-arrow">
          ...
          <form class="form-avatar" id="form-avatar-upload" enctype="multipart/form-data"  method="post">
            ...
            <input type="hidden" name="member_id" value="<?php echo $output['member_id']; ?>">
                    ...
                    <img src="<?php echo getImageUrl($output['member_icon'])?:WAP_SITE_URL.'/resource/image/default_avatar.png'; ?>" id="user_avatar_pic" />
...
<script src="<?php echo WAP_SITE_URL;?>/resource/script/PhotoClip/iscroll-zoom-min.js"></script>
<script src="<?php echo WAP_SITE_URL;?>/resource/script/PhotoClip/hammer.min.js"></script>
<script src="<?php echo WAP_SITE_URL;?>/resource/script/PhotoClip/lrz.all.bundle.js"></script>
<script src="<?php echo WAP_SITE_URL;?>/resource/script/PhotoClip/PhotoClip.js"></script>
...
function logout(){
  ...
  $.ajax({
    type: 'GET',
    url: '<?php echo WAP_SITE_URL;?>/index.php?act=member&op=logout',
    data: {},
    dataType: 'json',
    success: function(data){
      if(data.STS){
