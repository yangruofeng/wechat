...
class memberControl {
  ...
  public function indexOp(){
    $url = ENTRY_API_SITE_URL.'/member.account.index.php';
    $data = array();
  ...
  public function categoryDetailOp(){
    ...
    if( !$data['product_info'] ){
      showMessage('No info:'.$cate_id,null,errorCodesEnum::INVALID_PARAM);
    }
    $category_name = $data['product_info']['category_name'];
    Tpl::output('data', $data);
    Tpl::output('html_title', $category_name);
    Tpl::output('header_title', $category_name);
    Tpl::showPage('category.detail');
  }
