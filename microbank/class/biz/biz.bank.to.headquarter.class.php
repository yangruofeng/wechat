...
class bizBankToHeadquarterClass extends bizBaseClass
{
    ...
    public function __construct($scene_code)
    {
        ...
        $this->biz_code = bizCodeEnum::BANK_TO_HEADQUARTER;
    ...
    public function execute($bank_id,$user_id,$trading_password,$amount,$currency,$remark)
    {
        ...
        $mark = "Operator: ".$userObj->user_name;
        // 更新账本
        $rt = (new bankToHeadquarterTradingClass($bank_id,$amount,$currency,$mark))->execute();
        if( !$rt->STS ){
