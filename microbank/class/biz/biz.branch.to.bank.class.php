 ...
 * Time: 16:40
 */
class bizBranchToBankClass extends bizBaseClass
{
    public function __construct($scene_code)
    {
        ...
        $this->biz_code = bizCodeEnum::BRANCH_TO_BANK;
    ...
    public function execute($branch_id,$bank_id,$chief_teller_id,$trading_password,$amount,$currency,$remark)
    {
        ...
        */
        ...
        // 更新账本
        $rt = (new branchToBankTradingClass($branch_id,$bank_id,$amount,$currency,$mark))->execute();
        if( !$rt->STS ){
