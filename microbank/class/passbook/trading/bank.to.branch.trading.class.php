...
class bankToBranchTradingClass extends tradingClass {
    ...
    public function __construct($bankAccountId, $branchId, $amount, $currency,$remark=null)
    {
        parent::__construct();
        ...
        $this->subject = "Branch Withdraw From Bank";
        $this->remark = $remark;
        ...
        ' withdraw from bank->'.$bankObj->bank_name.'(.'.$bankObj->bank_account_no.'.)'.
        ":$amount".$currency;
    }
