...
class clientPaymentToClientTradingClass extends tradingClass {
    ...
    public function __construct($fromClientSavingsPassbook, $toClientSavingsPassbook, $amount, $currency)
    {
        ...
        '(cid:'.$this->from_member_info['obj_guid'].')'.' scan payment to '.
    ...
    protected function getTradingDetail()
    {
        ...
        $detail[]=$this->createTradingDetailItem(
            ...
            'Pay to '.$this->to_member_info['login_code']);
        // 转入客人储蓄账户 - 贷
        $detail[]=$this->createTradingDetailItem(
            ...
            'Receive from '.$this->from_member_info['login_code']);
