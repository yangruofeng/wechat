...
class balloonInterestClass extends periodicRepaymentClass {
...
//            if ($current_interest * $repaymentPeriodCount < $min_interest) {
//                $current_interest = round($min_interest / $repaymentPeriodCount, 2);
//            }
            // 本期应还ope_fee
            ...
            // 本期应还本金
            if( $i == $repaymentPeriodCount ){  // 最后一期
                // 修正本金
