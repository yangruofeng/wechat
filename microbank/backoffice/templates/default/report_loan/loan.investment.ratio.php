...
<script>
    ...
    function btn_search_onclick() {
        ...
        yo.dynamicTpl({
            tpl: "report_loan/loan.investment.ratio.list",
            dynamic: {
                api: "report_loan",
                method: "getLoanInvestmentRatioList",
                param: _values
            },
    ...
    function exportExcel() {
        ...
        _values.op = 'exportLoanInvestmentRatio';
    ...
    function printPage() {
        ...
        _values.op = 'printLoanInvestmentRatio';
        _values.tpl = 'report_loan/loan.investment.ratio.list';
