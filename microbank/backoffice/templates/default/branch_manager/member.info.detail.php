<link href="<?php echo BACK_OFFICE_SITE_URL ?>/resource/css/loan.css?v=13" rel="stylesheet" type="text/css"/>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
                <?php if ($output['source'] == 'approve'){ ?>
                <h3>Committee</h3>
                <ul class="tab-base">
                    <li><a href="<?php echo getUrl('loan_committee', 'approveCreditApplication', array(), false, BACK_OFFICE_SITE_URL) ?>"><span>List</span></a></li>
                    <li><a href="<?php echo getUrl('loan_committee', 'showRequestCredit', array('uid' => $output['suggest_id']), false, BACK_OFFICE_SITE_URL) ?>"><span>Approve</span></a></li>
                <?php } elseif($output['source'] == 'fast_grant') {?>
                    ...
                    <ul class="tab-base">
                        ...
                        <li><a href="<?php echo getUrl('loan_committee', 'fastGrantCreditDetail', array('member_id' => $output['member_id']), false, BACK_OFFICE_SITE_URL) ?>"><span>Grant Credit</span></a></li>
                <?php } elseif($output['source'] == 'written_off') {?>
                        <h3>Client</h3>
                        <ul class="tab-base">
                            <li>
                                <a href="<?php echo getUrl('loan_committee', 'approveWrittenOffRequest', array(), false, BACK_OFFICE_SITE_URL) ?>"><span>List</span></a>
                            </li>
                            <li><a href="<?php echo getUrl('loan_committee', 'handleWrittenOff', array('uid' => $output['off_id']), false, BACK_OFFICE_SITE_URL) ?>"><span>Written Off</span></a></li>
                <?php } else { ?>
                    <h3>Client</h3>
                    <ul class="tab-base">
                        <li>
                        ...
                        <li><a href="<?php echo getUrl('branch_manager', 'showClientDetail', array('uid' => $output['detail']['uid']), false, BACK_OFFICE_SITE_URL) ?>"><span>Credit Process</span></a></li>
                <?php }?>
    ...
    <div class="container">
        ...
        <input type="hidden" name="balance" id="balance"
               value="<?php echo memberClass::getCreditBalance($item['uid'])->DATA['balance'] ?: 0; ?>">
                ...
                <dl class="assets-basic clearfix">
                    ...
                    <div class="assets-info">
                        <div class="info-detail">
                            <div class="item item-usd">
                                <span class="block"></span><span class="p">USD: 1,000</span>
                            </div>
                            <div class="item item-cny">
                                <span class="block"></span><span class="p">CNY: 500</span>
                            </div>
                        </div>
                        <div class="epie-chart easyPieChart" data-percent="45" style="width: 120px; height: 120px;">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="information">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php $lang['source_type_' . $item['open_source']] ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <div class="list clearfix">
                                            ...
                                            <?php if ($count > 0) { ?>
                                                ...
                                                <span><i class="fa fa-check"></i>登录<em
                                                        onclick="_confirm('<?php echo blackTypeEnum::LOGIN; ?>', 0);"><i
                                                            class="fa fa-minus"></i></em></span>
                                                <span><i class="fa fa-check"></i>存款<em
                                                        onclick="_confirm('<?php echo blackTypeEnum::DEPOSIT; ?>', 0);"><i
                                                            class="fa fa-minus"></i></em></span>
                                                <span><i class="fa fa-check"></i>保险<em
                                                        onclick="_confirm('<?php echo blackTypeEnum::INSURANCE; ?>', 0);"><i
                                                            class="fa fa-minus"></i></em></span>
                                                <span><i class="fa fa-check"></i>信用贷<em
                                                        onclick="_confirm('<?php echo blackTypeEnum::CREDIT_LOAN; ?>', 0);"><i
                                                            class="fa fa-minus"></i></em></span>
                                                <span><i class="fa fa-check"></i>抵押贷<em
                                                        onclick="_confirm('<?php echo blackTypeEnum::MORTGAGE_LOAN; ?>', 0);"><i
                                                            class="fa fa-minus"></i></em></span>
                                            <?php } ?>
...
<script>
    ...
    var canvas = document.getElementById("assetsCanvas");
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        ctx.arc(60, 60, 60, startAngle, endAngle);
        ctx.fill();

        tempAngle += angle;
    }
    function _confirm(type, state) {
        msg = state == 0 ? 'Are you sure to put it on the blacklist?' : 'Are you sure to remove it from the blacklist?？';
        yo.confirm('Confirm', msg, function (_r) {
            if(!_r) return false;
            var uid = $('#uid').val();
            state = state == 0 ? 1 : 0;
            //提交修改
            yo.loadData({
                ...
                callback: function (_o) {
                    if (_o.STS) {
                        alert('Edited successfully!',1,function(){
                            window.location.reload();
                        });
                    } else {
                        alert('Edited failure', 2);
                    }
                }
            });
        });
    ...
    function showCheckDetail(member_id, cert_type) {
        ...
        yo.loadData({
            ...
            param: {member_id: member_id, cert_type: cert_type},
            callback: function (_o) {
                if (_o.STS) {
                    var url = _o.DATA;
