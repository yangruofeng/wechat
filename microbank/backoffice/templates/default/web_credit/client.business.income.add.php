            ...
            <div class="col-sm-6" style="position: relative;margin: 10px 0 0;padding: 0 10px 0 0;">
                <div class="basic-info">
                    <div class="ibox-title" style="background-color: #DDD">
                        <h5 style="color: black"><i class="fa fa-id-card-o"></i>Business Research
                            <?php if($income_research['state']>=100){?>
                                &nbsp;&nbsp;&nbsp; <kbd>USDED</kbd>
                            <?php }?>
                        </h5>
                    </div>
                    ...
                    <div class="content">
                        <form id="frm_business" method="POST" action="<?php echo getUrl('web_credit', $output['income_id']?'editMemberBusinessIncome':'addMemberBusinessIncome', array(), false, BACK_OFFICE_SITE_URL);?>">
                            <input type="hidden" name="member_id" value="<?php echo $client_info['uid']?>">
                            <input type="hidden" name="industry_id" value="<?php echo $industry_info['uid']?>">
                            <input type="hidden" name="income_id" value="<?php echo $output['income_id']?>">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="branch_code" class="form-control" value="<?php echo $output['branch_code']?>" <?php echo $output['branch_code'] ? 'readonly' : ''?>>
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" name="employees" class="form-control" value="<?php echo $income_research['employees']?>">
                                    <div class="error_msg"></div>
                                </div>
                            </div>
                            <div class="col-sm-12 form-group">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php if ($income_research) { ?>
                                        ...
                                        <div class="col-sm-4" style="padding-right: 0;line-height: 34px"><a href="javascript:void(0)" onclick="showMyGoogleMap('<?php echo $income_research['coord_x']?>','<?php echo $income_research['coord_y']?>')" style="font-style: italic">Google Map</a></div>
                                    ...
                                    <?php } else { ?>
                                        <input type="text" name="address_detail" class="form-control" value="<?php echo $income_research['address_detail']?>">
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-8 multiple-file-images clearfix">
                                    <?php if(count($output['image_list']) > 0){?>
                                        <?php foreach ($output['image_list'] as $v) {?>
                                            <div class="item">
                                                <?php if ($output['is_bm'] || $v['operator_id'] == $output['user_id']) { ?>
                                                    <span class="del-item"
                                                          onclick="delImageItem(this, '<?php echo $v['image_url']; ?>','image_files');">
                                    ...
                                    <div class="multiple-image-upload item" id="imageUpload">
                                        ...
                                        <?php $json = json_encode(array_column($output['image_list'],'image_url')?:array()); $json = str_replace("\\/", "/", $json); $json = str_replace('"', "'", $json);?>
                        ...
                        <div class="content" style="padding: 0px">
                            <table class="table co_suggest_list">
                                ...
                                <tr>
                                    ...
                                    <?php foreach($co_list as $k => $co){?>
                                        <td>
                                            <?php if($income_research_co[$k] && $k != 0) { ?>
                                                <em><?php echo $income_research_co[$k]['address_detail'] ?></em>
                                                <a href="javascript:void(0)" onclick="showMyGoogleMap('<?php echo $income_research_co[$k]['coord_x']?>','<?php echo $income_research_co[$k]['coord_y']?>')" style="font-style: italic;margin-left: 10px">Google Map</a>
                                            <?php } ?>
                                        </td>
                                    <?php }?>
                                </tr>
...
<div class="modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width: 700px">
        <div class="modal-content">
            ...
            <div class="modal-body"  id="myModalContent" style="margin-bottom: 20px;height: 500px;display: block">
