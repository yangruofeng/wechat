                ...
                <div role="tabpanel" class="tab-pane active" id="system_analysis">
                    <table class="table">
                        ...
                        <?php if($member_income['business']) { ?>
                            <?php $default_rate = $suggest_profile['default_business_rate'];
                            foreach ($member_income['business'] as $val) { ?>
                                <tr>
                                    <td><span class="pl-125"><?php echo $val['industry_name']?></span></td>
                                    <td><?php echo $val['profit'] . '*' . $default_rate . '% = '?><em><?php $income_monthly += $val['profit'] * $default_rate / 100; echo ncPriceFormat($val['profit'] * $default_rate / 100)?></em></td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
                            <tr>
