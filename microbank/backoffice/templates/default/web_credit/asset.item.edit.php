...
$image_list=resetArrayKey($image_list,"image_key");
var_dump($image_list);
?>
<div class="page">
    <div class="fixed-bar">
    ...
    <div class="container" style="margin-top: 10px;max-width: 800px">
        ...
        <div class="business-content">
            <div class="basic-info container" style="margin-top: 10px">
                ...
                <div class="content">
                    <form id="cbc_form" method="POST" enctype="multipart/form-data" action="<?php echo getUrl('web_credit', 'submitEditAssetItem', array(), false, BACK_OFFICE_SITE_URL);?>">
                        <input type="hidden" name="uid" value="<?php echo $asset['uid']?>">

                        <div class="col-sm-12 form-group">
                            <label class="col-sm-5 control-label"><span class="required-options-xing">*</span>Certification No.</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="asset_sn" value="<?php echo $asset['asset_sn']?>">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="asset_name" value="<?php echo $asset['asset_name']?>">
                                <div class="error_msg"></div>
                            </div>
                        </div>
                        <div class="col-sm-12 form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="asset_cert_type" class="form-control">
                                    <?php foreach($ct_list as $ct_k=>$ct_v){?>
                                        <option value="<?php echo $ct_v?>"  <?php if($ct_v==$asset['asset_cert_type']) echo 'selected'?>><?php echo $ct_k?></option>
                                    <?php }?>
                                </select>
                                <div class="error_msg"></div>
                            </div>
