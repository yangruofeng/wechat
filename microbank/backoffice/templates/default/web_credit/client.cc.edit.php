    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a  class="current"><span>Credit Controller</span></a></li>
            </ul>
        </div>
    </div>
    <div class="container" style="margin-top: 10px;max-width: 800px">
        ...
        <div class="business-content">
            <div class="basic-info container" style="margin-top: 10px">
                ...
                <div class="content">
                    <form id="frm_co" method="POST" action="<?php echo getUrl('web_credit_v2', 'editMemberCC', array(), false, BACK_OFFICE_SITE_URL);?>">
