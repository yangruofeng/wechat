...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>Disbursement</h3>
            <ul class="tab-base">
                <li><a href="<?php echo getUrl('report_outstanding', 'outstanding', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Outstanding Province</span></a></li>
                ...
                <li><a class="current"><span>Outstanding Product</span></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_outstanding/outstanding.product.list",
            dynamic: {
                api: "report_outstanding",
                method: "getLoanOutstandingProductList",
                param: _values
            },
