...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>Industry</h3>
            <ul class="tab-base">
                <li><a class="current"><span>Written Off Voter</span></a></li>
            </ul>
        </div>
    </div>
    <div class="container" style="width: 800px;">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><span class="required-options-xing"></span><?php echo 'Limit Voter For Written Off'?></label>
                <div class="col-sm-9">
                ...
                <?php foreach ($limit_list as $key => $item) { ?>
                    <div class="col-sm-offset-3 col-sm-9 voter-limit-item">
                        <div class="col-sm-11">
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="min_loss[]" placeholder="Min-Loss" value="<?php echo $item['min_loss']?>">
                            </div>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="max_loss[]" placeholder="Max-Loss" value="<?php echo $item['max_loss']?>">
                            </div>
                            <div class="col-sm-4">
...
<script type="text/html" id="survey-info">
    <div class="col-sm-offset-3 col-sm-9 voter-limit-item">
        <div class="col-sm-11">
            <div class="col-sm-4">
                <input type="text" class="form-control" name="min_loss[]" placeholder="Min-Loss" value="">
            </div>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="max_loss[]" placeholder="Max-Loss" value="">
            </div>
            <div class="col-sm-4">
