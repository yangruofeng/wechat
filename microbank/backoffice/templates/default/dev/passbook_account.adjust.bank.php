...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a href="<?php echo getUrl('dev', 'passbookAccountAdjust', array('type' => 'member'), false, BACK_OFFICE_SITE_URL ); ?>"><span>Member</span></a></li>
                ...
                <div class="modal-form">
                    <form class="form-horizontal" id="adjust_form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label"><?php echo 'Currency'?></label>
                            <div class="col-sm-8">
                                <span class="form-control" name="currency" readonly></span>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "dev/passbook_account.adjust.bank.list",
            dynamic: {
                api: "dev",
                method: "getBankListWithPassbookAccounts",
    ...
    function adjust_account(uid, currency, balances) {
        if(!uid){
            return;
        }
        $('#myModal input').val('');
