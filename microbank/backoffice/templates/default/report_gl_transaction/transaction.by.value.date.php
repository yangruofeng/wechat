    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a class="current"><span>Transaction By ValueDate</span></a></li>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_gl_transaction/transaction.by.value.date.list",
            dynamic: {
                api: "report_gl_transaction",
                method: "getTransactionByValueDateList",
                param: {
