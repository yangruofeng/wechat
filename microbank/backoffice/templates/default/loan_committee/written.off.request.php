                        ...
                        <td>
                            <div class="input-group">
                                <span class="input-group-btn verify-state">
                                   ...
                                   <button type="button" class="btn btn-default" value="100">Approved</button>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "loan_committee/written.off.request.list",
            dynamic: {
                api: "loan_committee",
                method: "getWrittenOffRequestList",
                param: _values
            },
