<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>User</h3>
            <ul class="tab-base">
                <li><a class="current"><span>Fast Credit</span></a></li>
                <li><a href="<?php echo getUrl('user', 'committee', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Grant Credit</span></a></li>
                <li><a href="<?php echo getUrl('user', 'committeeWrittenOff', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Written Off</span></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
