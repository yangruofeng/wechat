    ...
    <div class="container" style="width: 600px;">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="role_name" placeholder="" value="<?php echo $_GET['role_name']?>">
                ...
                <div class="col-sm-9 auth-list" id="auth-list" style="margin-top: 10px">
                    <?php foreach($output['auth_group_back_office'] as $k_1=>$v_1){?>
                        <div style="font-size: 16px" class="auth_group clearfix">
                            <input type="checkbox" name="auth_group[]" value="<?php echo $k_1?>" style="margin-right: 5px;"><?php echo L('auth_'.strtolower($k_1))?>
                            <ul class="list-group">
                                <?php foreach($v_1 as $v_2){?>
                                    <li class="list-group-item col-sm-6">
                                        <label class="col-sm-4 checkbox-inline" title="<?php echo L('auth_'.strtolower($v_2))?>"><input type="checkbox" name="auth_select[]" value="<?php echo $v_2?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 auth-list" id="auth-list" style="margin-top: 10px">
                    <?php foreach($output['auth_group_counter'] as $k_1=>$v_1){?>
                        <div style="font-size: 16px" class="auth_group clearfix">
                            <input type="checkbox" name="auth_group_counter[]" value="<?php echo $k_1?>" style="margin-right: 5px;"><?php echo L('auth_counter_'.strtolower($k_1))?>
                            <ul class="list-group">
                                <?php foreach($v_1 as $v_2){?>
                                    <li class="list-group-item col-sm-6">
                                        <label class="col-sm-4 checkbox-inline" title="<?php echo L('auth_counter_'.strtolower($v_2))?>"><input type="checkbox" name="auth_select_counter[]" value="<?php echo $v_2?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9" style="margin-top: 7px">
                    <label><input type="radio" value="1" name="role_status" checked><?php echo 'Valid'?></label>
                    <label style="margin-left: 10px"><input type="radio" value="0" name="role_status"><?php echo 'Invalid'?></label>
                </div>
            </div>
            <div class="form-group">
