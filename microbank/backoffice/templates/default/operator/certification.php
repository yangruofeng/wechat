                        ...
                        <tr>
                            <td>
                                <div class="input-group">
                                    <input type="text" class="form-control input-search" id="search_text" name="search_text" placeholder="Search for name/account">
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        var member_name = $('#search_text').val(), cert_type = $('#cert_type').val(), verify_state = $('.verify-state .btn.active').attr('value');
        yo.dynamicTpl({
            tpl: "operator/certification.list",
            dynamic: {
                api: "operator",
