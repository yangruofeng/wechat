...
<div class="page">
    ...
    <?php echo $help = $output['help'];?>
    <div class="container" style="width: 600px;">
        <form class="form-horizontal" method="post">
            <input type="hidden" name="form_submit" value="ok">
            <input type="hidden" name="uid" value="<?php echo $help['uid']?>">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="category">
                        <?php foreach($output['help_category'] as $key => $category){?>
                            <option value="<?php echo $key?>" <?php echo $key == $help['category'] ? 'selected' : '' ;?>><?php echo ucwords(strtolower($category));?></option>
                        <?php }?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="help_title" placeholder="" value="<?php echo $help['help_title'];?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea name="help_content" style="width: 600px;height:300px;" id="help_content">
                        <?php echo $help['help_content']?>
                    </textarea>
                    <div class="error_msg"></div>
                </div>
            </div>
            <?php if($help['questioner_name']) {?>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-3 control-label"><?php echo $help['is_system'] ? 'Creator Name' : 'Questioner Name'; ?></label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php echo $help['questioner_name'];?>" readonly>
                </div>
            </div>
            <?php }?>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="sort" placeholder="" value="<?php echo intval($help['sort']);?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9" style="margin-top: 7px">
                    <label><input type="radio" value="1" name="is_show" <?php echo $help['state'] != 10 ? 'checked' : ' '?>><?php echo 'Show'?></label>
                    <label style="margin-left: 10px"><input type="radio" value="0" name="status" <?php echo $help['state'] == 10 ? 'checked' : '' ?>><?php echo 'Not Show'?></label>
                </div>
            </div>
            <div class="form-group">
