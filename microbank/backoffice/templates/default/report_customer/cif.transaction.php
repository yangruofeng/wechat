...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>Customer</h3>
            <ul class="tab-base">
                <li><a href="<?php echo getUrl('report_customer', 'customer', array(), false, BACK_OFFICE_SITE_URL)?>"><span>List of Customers</span></a></li>
                <li><a class="current"><span>List of CIF Transaction</span></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_customer/cif.transaction.list",
            dynamic: {
                api: "report_customer",
                method: "getCIFTransactionList",
                param: {
