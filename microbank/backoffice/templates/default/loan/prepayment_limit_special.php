<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a href="<?php echo getBackOfficeUrl("loan","prepaymentLimit")?>"><span> Default List</span></a></li>
            ...
            <div class="col-sm-6">
                <ul class="list-group">
                    <?php foreach($output['category_list'] as $cate){?>
                        <?php if($output['category_info']['uid']==$cate['uid']){?>
...
<script>
    ...
    function btn_save_edit_onclick(_e){
        ...
        yo.loadData({
            _c:"loan",
            _m:"editPrepaymentLimitSpecial",
            param:{loan_days:_loan_days,limit_days:_limit_days,category_id:'<?php echo $output['category_info']['uid']?>'},
