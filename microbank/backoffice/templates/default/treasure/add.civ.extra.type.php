  ...
  <div class="fixed-bar">
    ...
    <form class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="trade_type" placeholder="" value="<?php echo $_GET['trade_type']?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <label class="radio-inline"><input type="radio" name="ext_type" value="<?php echo flagTypeEnum::INCOME?>" checked>Cash In</label>
                <label class="radio-inline"><input type="radio" name="ext_type" value="<?php echo flagTypeEnum::PAYOUT?>">Cash Out</label>
            </div>
        </div>
        <div class="form-group">
