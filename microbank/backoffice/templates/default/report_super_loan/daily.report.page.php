...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_super_loan/daily.report.data.list",
            dynamic: {
                api: "report_super_loan",
                method: "getDailyReportData",
                param: _values
            },
    ...
    function printPage() {
        ...
        _values.op = 'printDailyReport';
        _values.tpl = 'report_super_loan/daily.report.data.list';
