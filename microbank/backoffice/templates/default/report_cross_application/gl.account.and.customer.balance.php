    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a class="current"><span>GL Account and Customer Balance</span></a></li>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "report_cross_application/gl.account.and.customer.balance.list",
            dynamic: {
                api: "report_cross_application",
                method: "getGLAccountAndCustomerBalanceList",
                param: {
