...
$industry_name_json = my_json_decode($industry_info['industry_name_json']) ?: array();
$industry_json = my_json_decode($industry_info['industry_json']) ?: array();
$industry_json_kh = my_json_decode($industry_info['industry_json_kh']) ?: array();
$industry_json_type = my_json_decode($industry_info['industry_json_type']) ?: array();
$servey_code_keys = array_keys($industry_json);
?>
<div class="page">
    <div class="fixed-bar">
    ...
    <div class="container" style="width: 650px;">
        <form class="form-horizontal" method="post">
            ...
            <input type="hidden" name="uid" value="<?php echo $industry_info['uid']?>">
            <div class="form-group">
                <label class="col-sm-3 control-label"><span class="required-options-xing">*</span><?php echo 'Industry Code'?></label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="industry_code" placeholder="" value="<?php echo $industry_info['industry_code']?>">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="industry_category">
                        ...
                        <?php foreach ($output['industry_category']['item_list'] as $key => $val) { ?>
                            <option value="<?php echo $key?>" <?php echo $key == $industry_info['industry_category'] ? 'selected' : ''?>><?php echo $val?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="industry_name" placeholder="" value="<?php echo $industry_info['industry_name']?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <?php foreach($lang_lst as $lang_key=>$lang_value){?>
                <div class="form-group">
                    <label class="col-sm-3 control-label"><span class="required-options-xing">*</span><?php echo 'Name('.$lang_value.")"?></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="industry_name_json_<?php echo $lang_key?>" placeholder="" value="<?php echo $industry_name_json[$lang_key]?>">
                        <div class="error_msg"></div>
                    </div>
                </div>
            <?php }?>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="credit_rate" placeholder="" value="<?php echo $industry_info['credit_rate']?>">
                    <div class="error_msg"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <?php $industry_json = my_json_decode($industry_info['industry_json']);foreach ($industry_json as $key => $val) { ?>
                    <div class="col-sm-offset-3 col-sm-9 survey_info">
                        <div class="col-sm-11">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="survey_name_kh[]" placeholder="Khmer Name" value="<?php echo $industry_json_kh[$key]?>">
                            </div>
                            <div class="col-sm-4">
                                <select class="form-control" name="survey_type[]">
                                    <?php foreach ($output['survey_type'] as $k => $v) { ?>
                                        <option value="<?php echo $k?>" <?php echo $industry_json_type[$key] == $k ? 'selected' : ''?>><?php echo ucwords(strtolower($v))?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <label class="radio-inline"><input type="radio" value="1" name="state" <?php echo $industry_info['state'] ? 'checked' : ''?>>Valid</label>
                    <label class="radio-inline"><input type="radio" value="0" name="state" <?php echo !$industry_info['state'] ? 'checked' : ''?>>Invalid</label>
                </div>
            </div>
            <div class="form-group">
