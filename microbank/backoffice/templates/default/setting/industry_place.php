    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="<?php echo getUrl('setting', 'addIndustryPlace', array(), false, BACK_OFFICE_SITE_URL)?>"><span>Add</span></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl: "setting/industry_place.list",
            dynamic: {
                api: "setting",
                method: "getIndustryPlaceList",
