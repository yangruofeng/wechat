...
if ($_GET['_c'] == "base") $_GET['_c'] = 'back_office_base';

RpcRouter::handle(array(
    'defaultClass'=>'office_indexControl',
...
if ($st > 1) {
    debug("_home_index_time",
        "$st - " . $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] . " on " . $_SERVER['REMOTE_ADDR'] . "\n" .
