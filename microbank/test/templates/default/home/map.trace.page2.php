...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo 'AIzaSyA96UVKWM82_YHJx1h9j9-NhacFbGANf1k';// getConf("api_google_map")?>&v=3.exp"></script>
