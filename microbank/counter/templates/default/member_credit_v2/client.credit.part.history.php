            ...
            <?php foreach ($client_authorized_history as $k => $v) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if( $v['fee'] > 0){ ?>
                            USD <?php echo ncPriceFormat($v['fee'],0); ?>
                        <?php } ?>
                        <br />
                        <?php if($v['fee_khr']>0){ ?>
                            KHR <?php echo ncPriceFormat($v['fee_khr'],0); ?>
                        <?php }?>

                    </td>
                    <td>
                        <p>
                            <?php if(!$v['payment_way']){?>
                                Cash
                            <?php }else{?>
                                Balance
                            <?php }?>
                        ...
                        <?php if(!$v['payment_way']){?>
                            <p>
                                USD: <?php echo ncPriceFormat($v['cash_usd'])?>, KHR: <?php echo ncPriceFormat($v['cash_khr'],0)?>
                            </p>
                        <?php }?>
                    </td>
                    <td>
