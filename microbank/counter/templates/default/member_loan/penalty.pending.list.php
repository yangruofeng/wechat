...
$penalty_pending_list=$output['penalty_pending_list'];
?>
<div>
    <form style="margin-bottom: 0">
        <table class="table table-bordered">
            ...
            <tbody>
            <?php if ($penalty_pending_list) {  ?>
                <?php foreach ($penalty_pending_list as $key => $row) {; ?>
                    <tr>
                        <td>
                            <?php echo $row['uid'] ?>
                        </td>
                        ...
                        <td>
                            <?php echo ncPriceFormat($row['receivable']) ?>
                        </td>
                        <td>
                            <?php echo ncPriceFormat($row['deducting']) ?>
                        </td>
                        <td>
                            <?php echo ncPriceFormat($row['paid']) ?>
                        </td>
                        <td>
                        ...
                        <td>
                           <?php if($row['state']==loanPenaltyReceiptStateEnum::APPROVED){?>
