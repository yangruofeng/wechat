...
<div class="page">
    ...
    <div class="content">
        <div>
            <form class="prepayment_form" action="<?php echo getUrl('member_loan', 'confirmPrepaymentApply', array(), false, ENTRY_COUNTER_SITE_URL)?>" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width: 80%;height: 30px" name="prepayment_type">
                                <option value="<?php echo prepaymentRequestTypeEnum::FULL_AMOUNT; ?>"><?php echo 'Full Amount';?></option>
