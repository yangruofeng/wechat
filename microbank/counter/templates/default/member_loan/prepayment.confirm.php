            ...
            <div class="content">
                <div class="col-sm-6 mincontent">
                    <table class="table">
                        ...
                        <?php if($output['confirm_info']['prepayment_type'] == repaymentWayEnum::PASSBOOK){ ?>
                            <?php $i = 0;foreach($output['default_currency_amount'] as $currency => $amount){ ++$i?>
                                <tr>
                                    <td>
                                        <?php if($i == 1) {?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="snapshot_div" onclick="callWin_snapshot_slave_withdraw();">
                                    <img id="img_slave_prepayment" src="<?php echo $output['member_scene_image']?getImageUrl($output['member_scene_image']):'resource/img/member/photo.png'; ?>" style="width: 140px;">
                                </div>
                            </td>
                        </tr>
                ...
                <div class="col-sm-6 mincontent "  style="padding-left: 0px!important;">
                    <form id='client_prepayment'>
                        <input type="hidden" id="member_image" name="member_image" value="<?php echo $output['member_scene_image']; ?>">
                        <input type='hidden' class="form-control" name="biz_id" value="<?php echo $output['confirm_info']['biz_id'] ?>">
                        <input type='hidden' class="form-control" name="contract_id" value="<?php echo $output['contract_id']?>">
        ...
        yo.loadData({
            ...
            callback: function (_o) {
                ...
                if (_o.STS) {
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo getUrl('member_loan', 'contractIndex', array('contract_id'=>$output['contract_id']), false, ENTRY_COUNTER_SITE_URL) ?>";
                    },2000)
                } else {
                    alert(_o.MSG);
                }
