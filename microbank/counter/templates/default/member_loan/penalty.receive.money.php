<div style="padding-top: 15px">
     ...
     <div class="col-sm-7 mincontent">
         <div class="col-sm-12 form-group">
            ...
            <form id='penalty_two'>
                <input type="hidden" name="default_currency" value="<?php echo $data['data']['currency'] ?>"/>
                <input type="hidden" name="default_amount" value="<?php echo $data['data']['paid'] ?>"/>
                <div class="col-sm-12 form-group">
                    <label class="col-sm-4 control-label"><?php echo 'Receive Money From' ?></label>
                    <div class="col-sm-8">
                        <label class="control-label"><input type="radio" name="payment_way" value="<?php echo repaymentWayEnum::PASSBOOK ?>" checked onclick="changetype(this)"> <?php echo 'Balance'?></label><br/>
                        <label class="control-label"><input type="radio" name="payment_way" value="<?php echo repaymentWayEnum::CASH ?>" onclick="changetype(this)"><?php echo 'Cash'?></label>
                    </div>
                </div>
                <table class="col-sm-12 form-group" style="display: none" id="choose_currency">
                    <tr class="col-sm-12">
...
<script>
    ...
    function calcCurrencyAmount(_e) {
        ...
        //_amount = Math.ceil(_amount / _currency_min_value) * _currency_min_value;  // 总是存在进一位的问题
