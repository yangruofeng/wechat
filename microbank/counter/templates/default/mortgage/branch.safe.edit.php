...
<div class="page">
    ...
    <div class="container" style="width: 500px;">
        <form class="form-horizontal" method="post"
              action="<?php echo getUrl('mortgage', 'editBranchSafe', array(), false, ENTRY_COUNTER_SITE_URL)?>">
            <input type="hidden" name="form_submit" value="ok">
            <input type="hidden" name="uid" value="<?php echo $output['safe']['uid']?>">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-5 control-label"><?php echo 'Safe Code' ?></label>

                <div class="col-sm-7">
                    <input type="text" class="form-control" name="safe_code" value="<?php echo $output['safe']['safe_code']?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" name="remark"><?php echo $output['safe']['remark']?></textarea>
                </div>
            </div>
        </form>
        <div class="form-group">
