    ...
    <div class="collection-div">
        ...
        <div class="basic-info container">
            <div class="ibox-title">
                <h5><i class="fa fa-id-card-o"></i>Withdrawal Authorize</h5>
            </div>
            <div class="content">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="snapshot_div" onclick="callWin_snapshot_slave_withdraw();">
                                    <img id="img_slave_withdraw" src="<?php echo $output['member_scene_image']?getImageUrl($output['member_scene_image']):'resource/img/member/photo.png'; ?>"  style="width: 150px">
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="col-sm-6 mincontent"  style="padding-left: 0px!important;">
                    <form id='client_withdrawal'>
                        <input type="hidden" id="withdraw_member_image" name="withdraw_member_image" value="<?php echo $output['member_scene_image']; ?>">
                    ...
                    <div class="col-sm-12 form-group" style="text-align: center;">
                        <button type="button" class="btn btn-primary btn-block" onclick="btn_submit_withdrawal_onclick()"><i class="fa fa-arrow-right"></i>Submit</button>
                    </div>
                </div>
...
<script>
    ...
    function btn_submit_withdrawal_onclick() {
        if (!$("#client_withdrawal").valid()) {
            return;
        }
        $(document).waiting();
        ...
        yo.loadData({
            ...
            callback: function (_o) {
                ...
                if (_o.STS) {
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo getUrl('member_cash', 'withdrawIndex', array('member_id'=>$output['member_id']), false, ENTRY_COUNTER_SITE_URL) ?>";
                    },2000)
                } else {
                    alert(_o.MSG);
                }
        ...
        if (window.external) {
            try {
                ...
                if (_img_path != "" && _img_path != null) {
                    $("#img_slave_withdraw").attr("src", getUPyunImgUrl(_img_path, "180x120"));
                    $('#withdraw_member_image').val(_img_path);
                }
            } catch (ex) {
                alert(ex.Message);
            }
