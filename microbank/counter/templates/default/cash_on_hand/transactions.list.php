...
?>
    ...
    <?php if($data['data']){ ?>
        ...
        <tr>
            ...
            <td>
                <a type="button" class="btn btn-default" href="<?php echo getUrl('cash_on_hand', 'tradeDetail', array('uid'=>$row['trade_id']), false, ENTRY_COUNTER_SITE_URL)?>">
...
<?php if($data['data']){ ?>
    <div style="text-align: center;margin-top: 10px">
        <a class="btn btn-danger" style="min-width: 80px;" onclick="print_cod_flow()"><i class="fa fa-print"></i><?php echo ' Print' ?></a>
    </div>
<?php }?>