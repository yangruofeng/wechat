...
<!--                            </div>-->
            ...
            <div class="basic-info" style="margin-top: 10px">
                <div class="ibox-title">
                    <h5><span>System Balance</span>
                        <span style="padding-left:90px">
                        <?php foreach ($output['systemAccountBalance'] as $key => $value){ ?>
                            <span style="padding-left: 15px;color: black"><?php echo $key .' : '. ncPriceFormat($value)?></span>
...
<script>
    ...
    function btn_search_onclick(_pageNumber, _pageSize) {
        ...
        yo.dynamicTpl({
            tpl:"cash_on_hand/cash.out.list",
        ...
        yo.loadData({
            ...
            callback: function (_o) {
                if (_o.STS) {
                    ...
                    window.location.href='<?php echo getUrl('cash_on_hand', 'authorizeCashOut', array(), false, ENTRY_COUNTER_SITE_URL) ?>&biz_id='+_biz_id;
                } else {
                    alert(_o.MSG);
                }
            }
