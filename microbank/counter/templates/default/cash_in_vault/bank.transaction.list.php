            ...
            <?php if($data['data']){ ?>
                <?php foreach ($data['data'] as $row) { ?>
                    <tr>
                        ...
                        <td>
                            <a type="button" class="btn btn-default" href="<?php echo getUrl('cash_in_vault', 'bankTradeDetail', array('uid'=>$row['trade_id'],'bank_id'=>$output['bank_id']), false, ENTRY_COUNTER_SITE_URL)?>">
