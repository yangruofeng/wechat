        ...
        <div class="register-div" style="margin-top: 20px;max-width: 800px">
            <div class="basic-info">
                ...
                <div class="content" style="padding-left: 60px">
                    <form class="form-horizontal" style="width: 700px" id="form-change" action="<?php echo getUrl('member', 'memberChangeTradePwd', array(), false, ENTRY_COUNTER_SITE_URL) ?>"
                          method="post">
                        ...
                        <div class="col-sm-6 form-group" style="text-align: left;margin-left: 12px!important;margin-bottom: 5px">
                            <label class="control-label"><?php echo ncPriceFormat(global_settingClass::getChangeProfileFee()['change_trade_password']) ?></label>
                        </div>
                        <div class="col-sm-6 form-group title">
