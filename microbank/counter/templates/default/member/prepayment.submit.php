...
<div class="page">
    ...
    <div style="max-width: 700px">
        ...
        <div class="content">
            <div>
                <form class="receive_prepayment" action="<?php echo getUrl('member', 'receivePrepayment', array(), false, ENTRY_COUNTER_SITE_URL)?>" method="post">
                    ...
                    <table class="table contract-table">
                        ...
                        <tr>
                            ...
                            <td><label class="control-label"><?php echo $output['prepayment_info']['apply_info']['payable_principal']?></label></td>
                        </tr>
                        <tr>
                            <td><label class="control-label info">Interest</label></td>
                            <td><label class="control-label"><?php echo $output['prepayment_info']['apply_info']['payable_interest']?></label></td>
                        </tr>
                        <tr>
                            <td><label class="control-label info">Operation fee</label></td>
                            <td><label class="control-label"><?php echo $output['prepayment_info']['apply_info']['payable_operation_fee']?></label></td>
                        </tr>
                        <tr>
                            <td><label class="control-label info">Penalty</label></td>
                            <td><label class="control-label"><?php echo $output['prepayment_info']['apply_info']['payable_penalty']?></label></td>
                        </tr>
                        <tr>
                            <td><label class="control-label info">Total Amount</label></td>
                            <td><span class="money-style"><?php echo $output['prepayment_info']['apply_info']['total_payable_amount']?></span></td>
                        ...
                        <tr>
                            ...
                            <td><select class="form-control" name="repayment_way">
