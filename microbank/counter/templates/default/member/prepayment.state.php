            ...
            <div class="content">
                <div>
                    <table class="table contract-table">
                        ...
                        <tr>
                            <td class="width250"><label class="control-label">Client Code</label></td>
                        ...
                        <tr>
                            ...
                            <td><span class="money-style"><?php echo $output['prepayment_request']['total_payable_amount'] ?></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr style="text-align: center">
                            <td colspan="2">
                                ...
                                ?>
                                <a class="btn btn-default apply" <?php echo $is_apply ? '' : 'disabled';?> href="<?php echo $is_apply ? getUrl('member', 'prepaymentApply', array('contract_id' => $output['contract_info']['contract_id']), false, ENTRY_COUNTER_SITE_URL) : 'javascript:void(0)';?>">
                                    <i class="fa fa-check"></i><?php echo 'Apply' ?>
                                </a>
                                <a class="btn btn-default repayment" <?php echo $is_prepayment ? '' : 'disabled';?> href="<?php echo $is_prepayment ? getUrl('member', 'submitPrepayment', array('apply_id' => $output['prepayment_request']['uid']), false, ENTRY_COUNTER_SITE_URL) : 'javascript:void(0)';?>">
