...
<div>
    ...
    <div class="col-sm-12 member-info"  style="padding:5px;margin-top: 15px;position: relative">
        ...
        <div style="margin: 20px 0px";>
            ...
            <?php $i = 0;foreach ($output['owner_list'] as $value){ $i++ ?>
                <div style="margin-top: 12px;margin-left: 30px">
                    ...
                    <span class="down_line" style="width: 260px;"><?php echo $value['relative_name'] ?></span>
                    <span><?php echo $lang['print_gender']; ?></span>
                    <span class="down_line" style="width: 100px;"><?php echo $lang['member_gender_'.$value['gender']] ?></span>
                    <span><?php echo $lang['print_kind_of_id']; ?></span>
                    <span class="down_line" style="width: 140px;"><?php echo $lang['member_id_type_'.$value['id_type']] ?></span>
                    <span><?php echo $lang['print_no']; ?></span>
                    <span class="down_line" style="width: 248px;"><?php echo $value['id_sn'] ?></span>
                </div>
            <?php }?><?php $i = 0;foreach ($output['owner_list'] as $value){ $i++ ?>
                <div style="margin-top: 12px;margin-left: 30px">
                    <span><?php echo $lang['print_name']; ?></span>
                    <span class="down_line" style="width: 260px;"><?php echo $value['relative_name'] ?></span>
                    <span><?php echo $lang['print_gender']; ?></span>
        ...
        <div style="margin-top: 12px;margin-left: 30px">
            ...
            <span class="down_line" style="width: 180px;"><?php echo $basic_info['id_4'] ?></span>
            <span><?php echo $lang['print_commune']; ?></span>
            <span class="down_line" style="width: 177px;"><?php echo $basic_info['id_3'] ?></span>
            <span><?php echo $lang['print_district']; ?></span>
            <span class="down_line" style="width: 176px;"><?php echo $basic_info['id_2'] ?></span>
            <span><?php echo $lang['print_province']; ?></span>
            <span class="down_line" style="width: 180px;"><?php echo $basic_info['id_1'] ?></span>
        </div>
    </div>
        ...
        <?php if($assets_info[0]['uid']){?>
            <?php $i = 0;foreach ($assets_info as $value){ $i++ ?>
                <div style="margin-top: 12px;margin-left: 30px">
                    ...
                    <span class="down_line" style="width: 370px;"><?php echo $value['asset_name']?></span>
                    <span><?php echo $lang['print_no']; ?></span>
                    <span class="down_line" style="width: 256px;"><?php echo $value['asset_sn']?></span>
                    <span><?php echo $lang['print_date']; ?></span>
                    <span class="down_line" style="width: 235px;"><?php echo $value['cert_issue_time']?></span>
                </div>
            <?php }?>
            ...
            <?php for($k=$i;$k<4;$k++){ ?>
                <div style="margin-top: 12px;margin-left: 30px">
                    ...
                    <span class="down_line" style="width: 370px;"></span>
                    <span><?php echo $lang['print_no']; ?></span>
                    <span class="down_line" style="width: 256px;"></span>
                    <span><?php echo $lang['print_date']; ?></span>
                    <span class="down_line" style="width: 235px;"></span>
                </div>
            <?php }?>
