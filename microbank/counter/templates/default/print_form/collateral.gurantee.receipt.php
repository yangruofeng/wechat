...
<div>
    ...
    <div class="col-sm-12 member-info"  style="padding:5px;margin-top: 15px;position: relative">
        ...
        <div style="margin-top: 12px;">
            ...
            <span class="down_line" style="width: 160px;"><?php echo $basic_info['id_4']; ?></span>
            <span><?php echo $lang['print_commune']; ?></span>
            <span class="down_line" style="width: 157px;"><?php echo $basic_info['id_3']; ?></span>
            <span><?php echo $lang['print_district']; ?></span>
            <span class="down_line" style="width: 156px;"><?php echo $basic_info['id_2']; ?></span>
