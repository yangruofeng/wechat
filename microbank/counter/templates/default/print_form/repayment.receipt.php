...
<div>
    <div style="position: relative">
        ...
        <p style="margin-left: 110px"><span style="font-size: 19px;font-weight: 500;letter-spacing:10px;">គ្រឹះស្ថានមីក្រូហិរញ្ញវត្ថុ សំរឹទ្ធិស័ក លីមីតធីត</span><span style="margin-left: 35px">Date:</span><span class="down_line" style="width: 210px;left:768px;padding-left: 3px"><?php echo dateFormat($biz_info['update_time'], '-') ?></span></p>
        <p><span style="margin-left: 130px;font-weight: 400;font-size: 17px;"><?php echo $lang['print_samrithisak_microfinance_limited']; ?></span><span style="margin-left: 300px"><?php echo $lang['print_exchange_rate']; ?>:</span><span class="down_line" style="width: 140px;left:835px"> 1 USD = <?php echo $output['exchange_rate']?> KHR</span></p>
