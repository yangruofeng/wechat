    ...
    <div class="container">
        <div class="business-content" style="margin-bottom: 30px;">
            <div style="font-size: 14px;font-weight: 600;margin-bottom: 10px">
                ...
                <span style="margin-left: 30px"><?php echo $lang['print_from']; ?> : <span class="small"><?php echo $output['date_start']?></span> <?php echo $lang['print_to']; ?> : <span class="small"><?php echo $output['date_end']?></span> </span>
            </div>
