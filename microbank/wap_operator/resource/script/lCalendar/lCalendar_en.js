/**
 * Created by luo-biao on 2018-1-3.
 */
window.lCalendar = (function() {
	var MobileCalendar = function() {
		...
		this.maxM = 12,
		this.maxD = 31,
		this.enMonth = new Array('January','February','March','April','May','June','July','Aguest','September','October','November','December')
	}
		...
		bindEvent: function(type) {
			...
			function popupDate(e) {
				...
				_self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
					...
					'<div class="date_btn lcalendar_finish">Set</div>' +
					'</div>' +
			...
			function setDateGearTooth() {
				...
				if (date_mm && date_mm.getAttribute("val")) {
					...
					for (var p = 0; p < maxM - minM + 1; p++) {
						...
						itemStr += "<div class='tooth'>" + _self.enMonth[minM + p] + "</div>";
					}
