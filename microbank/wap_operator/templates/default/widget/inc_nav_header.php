...
<div class="home-header">
  ...
  <div class="header-btn clearfix">
    <span class="s-msg" onclick="javascript:location.href='<?php echo getUrl('message', 'index', array(), false, WAP_OPERATOR_SITE_URL)?>'">
      <img src="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/image/icon-msg.png" alt="" class="icon-msg">
...
<ul class="plus-list" style="display: none;">
  <li><a href="<?php echo getUrl('loan', 'hotLine', array(), false, WAP_OPERATOR_SITE_URL)?>"><?php echo 'Hotline';?></a></li>
</ul>
