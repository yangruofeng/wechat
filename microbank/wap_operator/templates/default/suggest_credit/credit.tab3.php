        ...
        <?php foreach($new_analysis['list_srs_new'] as $i=>$item){?>
            <tr>
                <td colspan="2" style="max-width: 70%">
                    ...
                    <p style="word-break: break-all;">Formula:<?php echo $item['formula']?></p>
                </td>
                <td class="text-right">
                    <?php echo $item['value']?>
                </td>
            ...
            <tr class="tr-summary">
                <td colspan="10">
                    <?php if($item['state_ability']){?>
                        <i class="weui-icon-success"></i><?php echo $item['category']?> coefficient >= 1.3
                    <?php }else{?>
                        <i class="weui-icon-cancel"></i><?php echo $item['category']?> coefficient <= 1.3
                    <?php }?>
                </td>
            </tr>
        <?php }?>
        ...
        <tr class="tr-summary">
            <td colspan="10">
                <?php if($new_analysis['state_credit']){?>
                    <i class="weui-icon-success"></i> coefficient >= 1.5
                <?php }else{?>
                    <i class="weui-icon-cancel"></i> coefficient <= 1.5
                <?php }?>
            </td>
        </tr>
    <?php }?>
